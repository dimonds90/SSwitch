...
# ADD CPP /nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_ATL_STATIC_REGISTRY" /FR /Yu"stdafx.h" /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /machine:I386
# Begin Custom Build - Registering "$(TargetPath)"
OutDir=.\Release
TargetPath=.\Release\MMSwitch.dll
InputPath=.\Release\MMSwitch.dll
SOURCE="$(InputPath)"
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_ATL_STATIC_REGISTRY" /FR /Yu"stdafx.h" /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /debug /machine:I386 /pdbtype:sept
# Begin Custom Build - Registering "$(TargetPath)"
OutDir=.\Debug
TargetPath=.\Debug\MMSwitch.dll
InputPath=.\Debug\MMSwitch.dll
SOURCE="$(InputPath)"
...
SOURCE=.\MMSwitchdll.cpp
# End Source File
# Begin Source File

SOURCE=.\MMSwitchEvents.cpp
# End Source File
# Begin Source File
